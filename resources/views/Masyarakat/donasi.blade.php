...
<form class="row g-3" method="POST" action="{{ route('donasi.store') }}" enctype="multipart/form-data">
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="NAMA_PENDONASI" name="NAMA_PENDONASI" value="{{ old('NAMA_PENDONASI') }}" required>
        @error('NAMA_PENDONASI')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-12">
        <label for="ALAMAT_PENDONASI" class="form-label">Alamat</label>
        <input type="text" class="form-control" id="ALAMAT_PENDONASI" name="ALAMAT_PENDONASI" value="{{ old('ALAMAT_PENDONASI') }}" required>
        @error('ALAMAT_PENDONASI')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-12">
        <label for="NO_TLPN_PENDONASI" class="form-label">Nomor Telepon</label>
        <input type="text" class="form-control" id="NO_TLPN_PENDONASI" name="NO_TLPN_PENDONASI" value="{{ old('NO_TLPN_PENDONASI') }}" required>
        @error('NO_TLPN_PENDONASI')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-12">
        <label for="JUMLAH_DONASI" class="form-label">Jumlah Uang Yang Didonasikan</label>
        <input type="text" class="form-control" id="JUMLAH_DONASI" name="JUMLAH_DONASI" value="{{ old('JUMLAH_DONASI') }}" required>
        @error('JUMLAH_DONASI')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-12">
        ...
        <p class="text-danger">*Foto bukti donasi harus berupa file jpeg, png, jpg dengan foto maksimal 2 Mb</p>
        <input type="file" class="form-control" id="FOTO_BUKTI_TRANSFER" name="FOTO_BUKTI_TRANSFER" required>
        @error('FOTO_BUKTI_TRANSFER')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-12">
        <label for="TGL_DONASI" class="form-label">Tanggal Pendaftaran</label>
        <input type="date" class="form-control" id="TGL_DONASI" name="TGL_DONASI" value="{{ old('TGL_DONASI') }}" required>
        @error('TGL_DONASI')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
